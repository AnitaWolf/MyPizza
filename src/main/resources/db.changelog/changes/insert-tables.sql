...
values ('88857ae2-22d4-4725-b27d-c3c9943a5aab', 'Domino', '+4912345678901', 'Munchen, Leopoldstr. 123, 80802',
        timestamp('2023-09-15 10:30:00'), '88857ae2-22d4-4725-b27d-c3c9943a5aab');
INSERT INTO cafe_data(id, cafe_name, phone, location, created_at, pizza_id)
values ('7a1ec8f9-56b7-4b99-8e9e-fab8dd27f6c2', 'Café Central', '+4987654321002', 'Munchen, Sendlinger Str. 25, 80331',
        timestamp('2023-09-15 10:30:00'), '88857ae2-22d4-4725-b27d-c3c9943a5aab');
INSERT INTO cafe_data(id, cafe_name, phone, location, created_at, pizza_id)
values ('a5d4f83c-8fa2-43c6-bec8-015187d4853e', 'Bavarian Brews', '+4976123456789',
        'Munchen, Schwanthalerstr. 8, 80336', timestamp('2023-09-15 10:30:00'), '88857ae2-22d4-4725-b27d-c3c9943a5aab');

# INSERT INTO cafe_data(id, cafe_name, phone, location, created_at, pizza_id)
# values ('88857ae2-22d4-4725-b27d-c3c9943a5aab', 'Bavarian Brews', '+4976123456789',
#         'Munchen, Schwanthalerstr. 8, 80336', timestamp('2023-09-15 10:30:00'), '88857ae2-22d4-4725-b27d-c3c9943a5aab');
...
insert into order_data_pizzas (pizza_id,order_id)
values ('a5d4f83c-8fa2-43c6-bec8-015187d4853e','aac493d6-2a12-4a92-aa17-26d0eef2ff88');
